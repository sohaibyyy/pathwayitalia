...
export function Hero() {
  return (
    <section id="top" className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 pt-40 pb-24 lg:pt-56 lg:pb-32 min-h-screen flex flex-col justify-center">
      ...
      <a
        href="#about"
        className="absolute left-1/2 -translate-x-1/2 bottom-8 z-10 text-ivory/80 flex flex-col items-center gap-2 text-[10px] uppercase tracking-[0.3em]"
      >
        Scroll
